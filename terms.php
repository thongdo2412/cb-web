  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-9 col-sm-offset-1 col-xs-10 col-xs-offset-1 main">
        ...
        <div class="linebreak24"></div>
        <h5><toBold>Review Of Submissions</toBold></h5>
        <div class="linebreak24"></div>
        ...
        <div class="linebreak24"></div>
        <h5><toBold>Product Availability</toBold></h5>
        <div class="linebreak24"></div>
        <p class="mainp">The availability of the products and services described on the Site, and the descriptions of such products and services, may vary based on location and timing.
        </p>
        <div class="linebreak24"></div>
        <h5><toBold>Contests</toBold></h5>
        <div class="linebreak24"></div>
        <p class="mainp">This Site may, from time to time, contain contests that offer prizes or that require you to submit material or information about yourself. Each contest has its own rules, which you must read and agree to before you may enter.
        </p>
        <div class="linebreak24"></div>
        <h5><toBold>Intellectual Property Rights</toBold></h5>
        <div class="linebreak24"></div>
        <p class="mainp">The Site, and all of its contents, including but not limited to articles, other text, photographs, images, illustrations, graphics, video material, audio material, including musical compositions and sound recordings, software, logos, titles, characters, names, graphics and button icons, excluding User Content (collectively "Proprietary Material"), are protected by copyright, trademark and other laws of the United States, as well as international conventions and the laws of other countries. The Proprietary Material is owned or controlled by City Beauty, LLC or by other parties that have provided rights thereto to City Beauty, LLC.
          <br/><br/>
        ...
        <div class="linebreak24"></div>
        <h5><toBold>Claims Regarding Copyright Infringement</toBold></h5>
        <div class="linebreak24"></div>
        <p class="mainp">Notice. If you are a copyright owner or an agent thereof and believe that any User Content or other content on the Site infringes upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act ("DMCA") by providing our Copyright Agent with the following information in writing (see 17 U.S.C 512(c)(3) for further detail):<br/>
          <ul>
        ...
        <p class="mainp">We control and operate the Site from our offices in the State of California, United States of America. While we invite visitors from all parts of the world to visit the Site, visitors acknowledge that the Site, and all activities available on and through the Site, are governed by the laws of the United States of America and the laws of the State of California. We do not represent that materials on the Site are appropriate or available for use in other locations. Persons who choose to access the Site from other locations do so on their own initiative, and are responsible for compliance with local laws, if and to the extent local laws are applicable.  All Products ship from the United States and customers are solely responsible for the payment of any applicable customs, import, export, and excise duty, VAT and/or other taxes and fees.
          ...
          <br/><br/>
          YOU AGREE THAT ANY CAUSE OF ACTION OR CLAIM THAT YOU MAY HAVE WITH RESPECT TO YOUR USE OF THE SITE OR ANY PRODUCT, CONTENT OR OTHER MATERIALS ON, ACCESSED THROUGH, PURCHASED OR DOWNLOADED FROM THE SITE MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE ACT OR OMISSION GIVING RISE TO THE CLAIM OR CAUSE OF ACTION AROSE.
          <br/><br/>
          If either party is required to retain the services of any attorney to enforce or otherwise litigate or defend any matter or claim arising out of, relating to or in connection with the Site, its content or the Products, then the prevailing party shall be entitled to recover from the other party, in addition to any other relief awarded or granted, its reasonable costs and expenses (including, without limitation, attorneys' fees and costs and/or court costs) incurred in the proceeding.
          <br/><br/>
          ...
          <br/><br/>
          These Terms and Conditions are the entire agreement between you and us with respect to the Site and any User Content, and supersede all prior or contemporaneous communications and proposals (whether oral, written or electronic) between you and us with respect to those matters. These Terms and Conditions shall be binding upon and inure to the benefit of each of the parties hereto, and their respective successors and permitted assigns.  You may not assign your rights or obligations under these Terms and Conditions at any time.  The parties agree that these Terms and Conditions shall be interpreted as though co-drafted by both parties hereto and any rules of contract interpretation favoring one party over the other shall be disregarded.  Captions and section headings used in these Terms and Conditions are for convenience only.  All necessary provisions shall survive any termination of these Terms and Conditions for any reason. If any provision of these Terms and Conditions is found to be unenforceable or invalid, that provision will be limited or eliminated to the minimum extent necessary so that these Terms and Conditions will otherwise remain in full force and effect and enforceable. The failure of either party to exercise in any respect any right provided for herein shall not be deemed a waiver of any further rights hereunder. No agency, partnership, joint venture, or employment relationship is created as a result of these Terms and Conditions, and neither party has any authority of any kind to bind the other in any respect. The failure of City Beauty, LLC to exercise in any respect any right provided for herein shall not be deemed a waiver of any of its rights hereunder.  Any specific right or remedy provided in these Terms and Conditions shall not be exclusive but shall be cumulative upon all other rights and remedies set forth these Terms and Conditions and allowed under applicable law.
        </p>
        <div class="linebreak24"></div>
        <h5><toBold>Notices</toBold></h5>
        <div class="linebreak24"></div>
        <p class="mainp">Unless otherwise specified in these Terms and Conditions, all notices under these Terms and Conditions will be in writing and will be deemed to have been duly given when received, if personally delivered or sent by certified or registered mail, return receipt requested; when receipt is electronically confirmed, if transmitted by facsimile or email; or the day after it is sent, if sent for next day delivery by recognized overnight delivery service.
          <br/><br/>
          Please feel free to contact us via one of the methods described on our Contact Us page, or send a letter to City Cosmetics Customer Care, 9361 Canoga Avenue Chatsworth, CA 91311. You agree that we may send notices to you regarding your use of the Site by means of electronic mail, a general notice posted on the Site or by written communication delivered either by overnight courier or U.S, mail to your email or mailing address as appearing in our records from time to time.
        </p>
        <div class="linebreak24"></div>
        These Terms and Conditions were last updated in April 10, 2017.
        <div class="linebreak24"></div>
      </div>
    </div>
    </div>
