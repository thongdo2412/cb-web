...
<div id="reviews_display">
  ...
  if (!$connErr){
    //prepare query
    if($stmt = $link->prepare("SELECT rateid,fname,email,subject,message,rate,recommend,DATE_FORMAT(postdate, '%m-%d-%Y'),helpful_y,helpful_n FROM `cc_$pid` ORDER BY postdate DESC LIMIT 0,5")){
			$stmt->execute();
...
<div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-8 hidden-xs text-left">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-4">Was this review helpful?</div>
      <div class="col-lg-1 col-md-1 col-sm-1 button_sm button_blue"><?php echo $helpful_y?></div>
      <div class="col-lg-1 col-md-1 col-sm-1 button_sm button_blue"><?php echo $helpful_n?></div>
    </div>
    <div class="linebreak2"></div>
    ...
    <div class="row">
      <div class="col-xs-9 col-xs-offset-1 text-left">
        ...
        <div id="testi<?php echo $rateid;?>" class="collapse">
          ...
          <div class="linebreak2"></div>
          <div class="row">
            <div class="col-xs-6">Was this review helpful?</div>
            <div class="col-xs-1 button_sm button_blue"><?php echo $helpful_y?></div>
            <div class="visible-xxs">&nbsp;</div>
            <div class="col-xs-1 button_sm button_blue"><?php echo $helpful_n?></div>
          </div>
          <div class="linebreak2"></div>
