...
$fields = array('name' => 'Customer Name', 'email' => 'Email', 'phone' => 'Phone', 'contact_type' => 'Preferred Contact Method', 'message' => 'Message'); // array variable name => Text to appear in the email
