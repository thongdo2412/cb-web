...
<div class="about-us-info">
        ...
        <h3>General Terms And Conditions</h3><br>

        <p>Unless otherwise noted, the products and services on the Site are intended for personal, non–commercial purposes only. You agree to use the Site only for lawful, noncommercial purposes and in compliance with all international, federal, state and local laws. Except as expressly permitted in these Terms and Conditions, you may not use, reproduce, distribute, reverse engineer, modify, copy, publish, display, transmit, adapt, frame, link, rent, lease, loan, sell, license or in any way exploit the content of the Site.
        </p>
        ...
        <h3>Review Of Submissions</h3><br>
        ...
        <p>The availability of the products and services described on the Site, and the descriptions of such products and services, may vary based on location and timing.
        </p>

        <h3>Contests</h3><br>

        <p>This Site may, from time to time, contain contests that offer prizes or that require you to submit material or information about yourself. Each contest has its own rules, which you must read and agree to before you may enter.
        </p>
        ...
        <h3>Claims Regarding Copyright Infringement</h3><br>

        <p>Notice. If you are a copyright owner or an agent thereof and believe that any User Content or other content on the Site infringes upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act ("DMCA") by providing our Copyright Agent with the following information in writing (see 17 U.S.C 512(c)(3) for further detail):<br/>
          <ul>
        ...
        <p>Unless otherwise specified in these Terms and Conditions, all notices under these Terms and Conditions will be in writing and will be deemed to have been duly given when received, if personally delivered or sent by certified or registered mail, return receipt requested; when receipt is electronically confirmed, if transmitted by facsimile or email; or the day after it is sent, if sent for next day delivery by recognized overnight delivery service.
          <br/><br/>
          Please feel free to contact us via one of the methods described on our Contact Us page, or send a letter to City Beauty Customer Care, 9361 Canoga Avenue Chatsworth, CA 91311. You agree that we may send notices to you regarding your use of the Site by means of electronic mail, a general notice posted on the Site or by written communication delivered either by overnight courier or U.S, mail to your email or mailing address as appearing in our records from time to time.
        </p>
        <p>These Terms and Conditions were last updated in April 10, 2017.</p>
	</div>
