        ...
        <div class="col">
          <div class="jumbotron jumbotron_wht" style="text-align: center;">
            ...
            <div class="innerbox">
                ...
                <h2>We're excited about our new look!</h2>
                <div class="linebreak24"></div>
                <div class="innertext">Click below to check out the entire line up, or just browse the rest of this site. Make sure to check back often for more updates.</div>
                <div class="linebreak24"></div>
                <a href="products.php" class="btn1 orangebtn" target="_blank">CLICK HERE TO SHOP</a>
            </div>
          </div>
        </div>
      </div>
