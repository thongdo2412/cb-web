							...
							<div class="product-detail-tabs">
								<div class="tab-content">
									<div class="tab-pane fade show active" id="image-one" role="tabpanel" aria-labelledby="image-one-tab">
										<img src="images/products/other products/undereye-1.png" alt="" />
									</div>
									<div class="tab-pane fade" id="image-two" role="tabpanel" aria-labelledby="image-two-tab">
										<img src="images/products/other products/undereye-2.png" alt="" />
									</div>
								</div>
            ...
            <div id="tabContent1" class="row collapseItemSM">
              ...
              <div class="plusminus col-1" data-toggle="collapse" data-target="#info-tab-one">+</div>
						...
						<div class="tab-pane fade show active" id="info-tab-one" role="tabpanel" aria-labelledby="product-info-tab-one">
							...
							<p><b>Under Eye Recovery</b> is a unique formula that uses both advanced color correctors and instant light-scattering optics to give you the bright, youthful eyes you've always wanted.</p>
							<h4>Features</h4>
							<ul>
              ...
              <div class="plusminus col-1" data-toggle="collapse" data-target="#info-tab-three">+</div>
						...
						<div class="tab-pane fade" id="info-tab-three" role="tabpanel" aria-labelledby="product-info-tab-three">
							<div class="row">
								...
								<div class="col-xl-10 col-lg-9 col-md-9">
									<span>What is Under Eye Recovery?</span>
									...
									<span>How does Under Eye Recovery work?</span>
									...
									<div class="separator"></div>
									<span>What are the main ingredients in Under Eye Recovery?</span>
									...
									<p><i>RejuvenOX</i>: Infuses aging, suffocated tissues with revitalizing oxygen to improve blood flow, reduce fine lines and smooth out your skin's texture. </p>
								</div>
							</div>
						</div>
