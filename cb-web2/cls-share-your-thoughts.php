...
<html lang="en">
    <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title>City Lips&reg; - Share Your Experience</title>
  ...
  <style>
    ...
    h2 {font-size: 30px;}
    h3 {font-size: 25px;}
    h4 {font-size: 20px; margin: 0; font-family: "Montserrat", sans-serif;}
    html,body {font-size: 16px; font-family: "Montserrat", sans-serif; font-weight: 300; color: #333333;}
    ...
    .gray_bg_content {width: 550px; margin: auto;}
    .gray_bg_content h2 {margin: 0;}
    .content_box {padding: 50px 0; text-align: center;}
    .flex_container1{
    ...
    .left_gap {margin-left: 26px; text-align: left; margin-top: 40px;}
    ...
    <div class="container">
      <div class="content_box">
        ...
        <h4>We’re thrilled you’re enjoying City Lips<span class="sup1">&reg;</span>!</h4>
        <div class="linebreak30"></div>
        <p>Now we’d like to offer you a chance to get some free products from City Beauty<span class="sup1">&reg;</span>.</p>
        ...
        <div class="gray_bg_content">
          ...
          <ul class="flex_container1">
            ...
            <li class="flex_container2">
          	...
          	<div class="button_wrap" style="letter-spacing:1px;"><a href="https://search.google.com/local/writereview?placeid=ChIJXx18GHebwoAR2W1sB6e_l2c" class="long_btn button_blue">click here to get started</a></div>
        </div>
      </div>
