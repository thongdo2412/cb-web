...
<script>
    ...
    .flexcontainer{padding: 0;margin: 0 auto;list-style: none;display: -webkit-box;display: -moz-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-flex-flow: row nowrap;justify-content: center;}
		header {background-color: #000; text-align:center; padding:10px; height: 60px;}
...
<body>
	...
	<div id="mainContent">
		<div class="container">
		<h1 align="center" id="orderSection">Last Week Alone - Over 1,405 Women Choose CityLips<sup><small>&reg;</small></sup></h1>
        <div class="orderOptions">
					<ul class="productwrapper">
            <li><img src="../img/citylips.png" alt="citylips" style="max-height: 300px;"></li>
						<li><img src="../img/bf_aft.png" alt="bf_after" style="max-height: 300px;"></li>
					</ul>
					<div id="product">
						<div class="perTube">
							Per Tube:
						...
						<div class="save">
							...
							<div class="innerRight">
								<div class="save"><span class="green">$10 Off Retail</span></div>
							</div>
							<div class="clear"></div>
							<div class="shrink savings">*change QTY for extra savings</div>
						</div>
						<select name="quantity" id="quantity">
							<option value="1">Qty: 1 Tube (save $10)</option>
							<option value="2">Qty: 2 Tubes (save $24)</option>
							<option value="3">Qty: 3 Tubes (save $48)</option>
						</select>
					</div>
      ...
      <div id="drturk">
        <div class="container flexcontainer">
          ...
          <img src="../img/research_screenshot2.png" alt="" style="width: 100%;">
				</div>
				<hr>
		...
		$(document).ready(function(){
			$("#quantity").change(function(){
				if($("#quantity option:selected").val() == "3"){
					$("#product .perTube .innerRight").html("29.00");
					$("#product .total .innerRight b").html("87.00");
					$("#product .total .innerRight .shipping").html("+ Free Shipping");
					$("#product .save .innerRight .save").html("<span class='green'>$48 Off Retail</span>");
					$("#productLink").attr("href", "http://citybeauty.com/cmd.php?pid=deb80b84100a4f079caafb80769a083c&bn=1&clear=1&mob=1&coup=1");
					$(".shrink.savings").html("&nbsp;");
				}
				else if($("#quantity option:selected").val() == "2"){
					$("#product .perTube .innerRight").html("33.00");
					$("#product .total .innerRight b").html("66.00");
					$("#product .total .innerRight .shipping").html("+ Free Shipping");
					$("#product .save .innerRight .save").html("<span class='green'>$24 Off Retail</span>");
					$("#productLink").attr("href", "http://citybeauty.com/cmd.php?pid=8021f125fc424998865e0f4ea777347f&bn=1&clear=1&&mob=1&coup=1");
					$(".shrink.savings").html("*change QTY for extra savings");
				}
				else if($("#quantity option:selected").val() == "1"){
					$("#product .perTube .innerRight").html("35.00");
					$("#product .total .innerRight b").html("35.00");
					$("#product .total .innerRight .shipping").html("+4.95 Shipping");
					$("#product .save .innerRight .save").html("<span class='green'>$10 Off Retail</span>");
					$("#productLink").attr("href", "http://citybeauty.com/cmd.php?pid=9fa8539faceb4050bbc0ddff0d905b65&bn=1&clear=1&mob=1&coup=1");
					$(".shrink.savings").html("*change QTY for extra savings");
				}
			});
