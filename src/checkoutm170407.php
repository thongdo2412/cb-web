...
<body>
	...
	<div id="mainContent">
        ...
        <div class="orderOptions">
            ...
            <li><img src="../img/citylips.png" alt="citylips"></li>
						<li><img src="../img/bf_aft.png" alt="bf_after"></li>
					</ul>
					<div id="product">
						<div class="perTube">
							Per Tube:
						...
						<div class="save">
							...
							<div class="innerRight">
								<div class="save"><span class="green">$10</span></div>
							</div>
							<div class="clear"></div>
		...
		$(document).ready(function(){
			$("#quantity").change(function(){
				if($("#quantity option:selected").val() == "3"){
					$("#product .perTube .innerRight").html("$29");
					$("#product .total .innerRight b").html("87.00");
					$("#product .total .innerRight .shipping").html("+ Free Shipping");
					$("#product .save .innerRight .save").html("<span class='green'>$48</span>");
					...
					$("#product .total .innerRight .shipping").html("+ Free Shipping");
					$("#product .save .innerRight .save").html("<span class='green'>$24</span>");
					...
					$("#product .perTube .innerRight").html("$35");
					$("#product .total .innerRight b").html("$35");
					$("#product .total .innerRight .shipping").html("+$4.95 Shipping");
					$("#product .save .innerRight .save").html("<span class='green'>$10</span>");
