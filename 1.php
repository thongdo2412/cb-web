<?php
  ...
  if ($mobile_browser == 0 or $tablet_browser == 0) {
     // do something for mobile devices
     header('Location: https://vitalupdates.com/s/new-breakthrough-allows-women-to-get-fuller-lips-at-home.php'. $_SERVER['QUERY_STRING']);
  }
...
<html>
    <head>
      ...
      <!-- End Google Tag Manager -->
         ...
         *{text-decoration: none; max-width: 100%;}
         html,body{margin: 0 auto;margin-left: auto;margin-right: auto; padding: 0; box-sizing: border-box; font-family: 'Roboto', sans-serif;}
         img{border: none;}
         ...
         header{background-color: #193665; color: white; top: 31px; z-index: 99;}
         ...
         .topMenu a{color: inherit;cursor: pointer;text-decoration: none;}
         ...
         #authorSection{border: 1px solid #eee; padding: 20px;margin-bottom: 40px;}
         ...
         #popularStories p {line-height: 28px;}
    ...
    <body>
      ...
      <header id="dsktophdr">
          <div class="container">
              <h1>Vital Updates<span class="tradeMark">&trade;</span></h1>
              <ul class="topMenu">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 col-md-12">
              ...
              <p class="author">By <b><a href="#" onclick="return false;">Brittany Artwohl</b></a> - <script type="text/javascript">
              now = new Date()
              ...
              <div id="buttons">
                  ...
                  <div class="twitter button">
                      ...
                      <a href="https://twitter.com/share" class="twitter-share-button" data-via="mariuCSS" style="position: absolute;">Tweet</a>
                      <script>
                          !function(d,s,id){
                  ...
                  <div class="google button">
                       <a href="http://plus.google.com/share?url=http://vitalupdates.com/new-research-reports-that-certain-foods-can-be-the-source-of-skin-issues/">
                      <i class="icon">
                  ...
                  <img src="images/pinterest-logo.jpg"  class="pinIcon"/>
                  </a>
              </div>
              <div id="socialicons">
                <!-- AddToAny BEGIN -->
              ...
              <p>Hours after the press conference, the Renee released a video presentation to the public, explaining exactly how her new solution lip-plumping works — and how anyone can use it.</p>
                ...
                <a href="http://healthyfullerlips.com/presentation/m170829.php" class="watchTheVideoButton" style="color: black; font-size: 22px; font-weight: bold;">Watch the presentation here:</a>
                <div class="flexwrapper">
                  <a href="http://healthyfullerlips.com/presentation/m170829.php">
