...
.heading .subheading{font-family: "Montserrat",sans-serif;font-size: 18px; font-weight: 200;line-height: 24px;}
  ...
  <div class="topline">1-800-347-1558 • M-F: 5am-7pm PT • S-S: 6am-4:30pm PT</div>
    ...
    <footer class="centered_flex">
     <div class="container">
       <div class="floatL">
         <p>&copy; City Beauty, LLC 2017. City Lips<sup>&reg;</sup> is a registered trademark of City Beauty, LLC. All rights reserved.</p>
       </div>
       <div class="floatR">
         <p><a href="http://citybeauty.com/privacy.php">PRIVACY POLICY</a> &nbsp;|&nbsp; <a href="http://citybeauty.com/terms.php">TERMS &amp; CONDITIONS</a></p>
       </div>
       <div class="clearfix"></div>
     </div>
   </footer>
