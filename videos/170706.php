...
.caption{font-size: 10px; font-style: italic; line-height: 14px; padding-bottom: 7px;}
  ...
  <div id="maincontent">
    <div class="container">
      <div class="left-info">
        ...
        <hr>
        <p class="info-p">The at-home "trick" to smoother, younger lips, in under 30-seconds</p>
        <hr>
        <p class="info-p" style="padding-bottom: 15px;">A common “cure” that almost never works & actually causes your lips to age faster</p>
