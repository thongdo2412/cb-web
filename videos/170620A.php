...
<script>
  ...
  <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Montserrat:200,300,300i,400,400i|Playfair+Display:300,300i,400,400i">
	<style>
		...
		h1{font-size: 40px;font-family: "Playfair Display", serif;}
		h2{font-size: 30px;}
    ...
    .small-title{font-size: 12px;margin-top: 50px;}
    .yellow-font{color:#e0c278}
    .linebreak1{margin-top: 24px;}
    .linebreak2{margin-top: 34px;}
    .linebreak3{margin-top: 56px;}
    .truth-section{background: url("../img/truth-section-bg.png") center no-repeat;background-size: cover;margin-bottom: -8px;height: 750px;}
    ...
    .flexitem2{margin-left: 38px;margin-top: -18px;}
    .floatL{float: left;}
    .floatR{float: right;}
  ...
  <div class="truth-section">
	  <div class="container">
          <div class="small-title">
            TODAY | <span class="yellow-font"> BEAUTY</span>
          </div>
      ...
      <div class="container">
        <div class="linebreak2"></div>
         ...
         <div class="flexcontainer">
           <div class="flexitem1">
             <img src="../img/lips-photo-videop.png">
           </div>
           <div class="flexitem2">
